...
export default function ModuleBox({moduleCode, banner}: {moduleCode: string, banner: string}) {
    return (
        ...
        <div className="w-76 shadow-black/10 shadow-md rounded-md bg-gradient-to-r from-primary/50 from-0% via-secondary/50 via-110% to-secondary/50 to-100%">
            <div className="rounded-t-md w-full h-38">
                <img src={banner} className="object-cover w-full h-full rounded-t-md" />
            </div>
