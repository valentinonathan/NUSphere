...
export default function Aside() {
    return (
        <aside className="fixed pt-6.5 px-6.5 min-h-full min-w-42 w-42 max-w-42 overflow-clip shadow-md bg-gradient-to-b from-primary/40 from-0% via-secondary/40 via-110% to-secondary/40 to-100% backdrop-blur-md" style={{boxShadow:"10px 0 24px rgba(0,0,0,0.2)"}}>
