      ...
      <body className="min-h-screen h-screen flex flex-col">
        <div className="flex flex-col flex-1 bg-center bg-cover" style={{backgroundImage: `url(${background.src})`}}>
          ...
          <main className="flex h-full">
            <aside className="pt-6.5 px-6.5 sticky min-h-full shadow-md bg-gradient-to-b from-primary/40 from-0% via-secondary/40 via-110% to-secondary/40 to-100% backdrop-blur-md" style={{boxShadow:"18px 0 24px rgba(0,0,0,0.1)"}}>
